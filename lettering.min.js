  ...
  createClass(Lettering, [{
    ...
    value: function _blink() {
      ...
      var _blinkAnimate = function _blinkAnimate() {
        ...
        if (delta > 1000 / 2) {
          _this.outputCaret.style.opacity--;
          console.log(_this.outputCaret.style.opacity);
          if (_this.outputCaret.style.opacity < 0) _this.outputCaret.style.opacity = 1;
          lastTime = now;
        }

        rAF(_blinkAnimate.bind(_this));
      };

  ...
  createClass(Lettering, [{
    ...
    value: function _animate() {
      ...
      if (this.stringIndex === this.maxStringIndex) {
        return this.stop().trigger('afterTyping');
      }

      if (this.stringIndex === 0) {
        return this.stop().trigger('afterBackspace');
      }
    ...
    value: function updateContent(string) {
      ...
      this.backspace().on('afterBackspace', function () {
        _this3.string = string;
        _this3.stringUpdated && _this3.typing();
        _this3.stringUpdated = false;
      });
    }
  }, {
    key: 'typing',
